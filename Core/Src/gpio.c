...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, POWER_OUT1_Pin|POWER_OUT2_Pin|POWER_5V_Pin|CS2_ACCEL_Pin
                          |CS2_GYRO_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : CS2_ACCEL_Pin CS2_GYRO_Pin */
